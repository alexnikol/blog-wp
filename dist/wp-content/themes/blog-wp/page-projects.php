    ...
    <div class="grid grid--rows">
        ...
        <div class="grid__layout">
            ...
            <?php foreach ($projects as $project):
                $name = get_the_title($project->ID);
                $description = get_field('description', $project->ID);
                $link = get_field('app_store_link', $project->ID);
                ...
                <div class="grid__item-body">
                    ...
                    <header>
                        ...
                        <h3 class="grid__item-title">
                            <a href="#" rel="bookmark"><?= $name; ?></a>
                        </h3>

                        <span class="grid__item-status<?= $status_class; ?>"><?= $status_label; ?></span>

                    </header>

                    <div class="grid__item-content"><?= $description; ?></div>

                    <?php if($status == "released"): ?>
                    <footer class="grid__item-footer">
                        <a href="<?= $link; ?>" class="grid__apple-link" target="_blank">
