...
$t_link = "https://twitter.com/intent/tweet?url=". get_permalink() ."&text=". get_the_title();
$l_link = "http://www.linkedin.com/shareArticle?mini=true&url=". get_permalink() ."&title=". get_the_title();
